...
var script = {
  ...
  mounted: function mounted() {
    ...
    window.addEventListener('scroll', lodash_throttle(this.handleScroll, 15), passiveIfSupported);
...
export { VueScrollProgressBar, install };
